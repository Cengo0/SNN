...
// ==============================================================
`timescale 1 ns / 1 ps
(* DowngradeIPIdentifiedWarnings="yes" *) module snn_top_hls_weight_memory_RAM_T2P_BRAM_3R2W (
    address0, ce0,
    d0, we0,
    q0,
    address1, ce1,
...
initial begin
    $readmemh("./snn_top_hls_weight_memory_RAM_T2P_BRAM_3R2W.dat", ram);
end
