...
wire  signed [7:0] sext_ln521_fu_105_p1;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        post_eligibility_addr_reg_126 <= zext_ln516_fu_85_p1;
    end
end

always @ (*) begin
    if (((icmp_ln516_fu_73_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign post_eligibility_address1 = post_eligibility_addr_reg_126;

assign post_eligibility_ce0 = post_eligibility_ce0_local;

assign post_eligibility_ce1 = post_eligibility_ce1_local;

assign post_eligibility_d1 = sub_ln521_fu_109_p2;

assign post_eligibility_we1 = post_eligibility_we1_local;

assign sext_ln521_fu_105_p1 = $signed(trunc_ln_fu_95_p4);

assign sub_ln521_fu_109_p2 = ($signed(post_eligibility_q0) - $signed(sext_ln521_fu_105_p1));

assign trunc_ln_fu_95_p4 = {{post_eligibility_q0[7:3]}};

assign zext_ln516_fu_85_p1 = ap_sig_allocacmp_j_1;
