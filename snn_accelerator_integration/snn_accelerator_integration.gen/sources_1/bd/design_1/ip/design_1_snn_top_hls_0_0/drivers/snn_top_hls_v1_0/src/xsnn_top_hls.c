...
void XSnn_top_hls_Set_mode_reg(XSnn_top_hls *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XSnn_top_hls_WriteReg(InstancePtr->Ctrl_BaseAddress, XSNN_TOP_HLS_CTRL_ADDR_MODE_REG_DATA, Data);
}

u32 XSnn_top_hls_Get_mode_reg(XSnn_top_hls *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XSnn_top_hls_ReadReg(InstancePtr->Ctrl_BaseAddress, XSNN_TOP_HLS_CTRL_ADDR_MODE_REG_DATA);
    return Data;
}

void XSnn_top_hls_Set_time_steps_reg(XSnn_top_hls *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XSnn_top_hls_WriteReg(InstancePtr->Ctrl_BaseAddress, XSNN_TOP_HLS_CTRL_ADDR_TIME_STEPS_REG_DATA, Data);
}

u32 XSnn_top_hls_Get_time_steps_reg(XSnn_top_hls *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XSnn_top_hls_ReadReg(InstancePtr->Ctrl_BaseAddress, XSNN_TOP_HLS_CTRL_ADDR_TIME_STEPS_REG_DATA);
    return Data;
}
...
void XSnn_top_hls_Set_encoder_config(XSnn_top_hls *InstancePtr, XSnn_top_hls_Encoder_config Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XSnn_top_hls_WriteReg(InstancePtr->Ctrl_BaseAddress, XSNN_TOP_HLS_CTRL_ADDR_ENCODER_CONFIG_DATA + 0, Data.word_0);
    XSnn_top_hls_WriteReg(InstancePtr->Ctrl_BaseAddress, XSNN_TOP_HLS_CTRL_ADDR_ENCODER_CONFIG_DATA + 4, Data.word_1);
    XSnn_top_hls_WriteReg(InstancePtr->Ctrl_BaseAddress, XSNN_TOP_HLS_CTRL_ADDR_ENCODER_CONFIG_DATA + 8, Data.word_2);
}

XSnn_top_hls_Encoder_config XSnn_top_hls_Get_encoder_config(XSnn_top_hls *InstancePtr) {
    XSnn_top_hls_Encoder_config Data;

    Data.word_0 = XSnn_top_hls_ReadReg(InstancePtr->Ctrl_BaseAddress, XSNN_TOP_HLS_CTRL_ADDR_ENCODER_CONFIG_DATA + 0);
    Data.word_1 = XSnn_top_hls_ReadReg(InstancePtr->Ctrl_BaseAddress, XSNN_TOP_HLS_CTRL_ADDR_ENCODER_CONFIG_DATA + 4);
    Data.word_2 = XSnn_top_hls_ReadReg(InstancePtr->Ctrl_BaseAddress, XSNN_TOP_HLS_CTRL_ADDR_ENCODER_CONFIG_DATA + 8);
    return Data;
}
