...
HD_PWD='/home/chipwisperer/Documents/SNN/snn_accelerator_integration/snn_accelerator_integration.runs/design_1_snn_top_hls_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_snn_top_hls_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_snn_top_hls_0_0.tcl
